...
<div class="hint">
  ...
  <p>
    ...
    <kbd>Shift</kbd>+<kbd>клік</kbd> — додати до виділення, <kbd>Shift</kbd>+<kbd>протягнути</kbd> — рамкою<br />
    <kbd>тягнути смужку кольору</kbd> — місце доріжки, <kbd>нижній край</kbd> — її висота<br />
